# Chaos Documentation
The aim of the chaos documentation is to provide a blueprint for contributors to raise their concerns and dissatisfaction with the current implementations and documentation.

> Whether you think you can or you think you can't, you're right
> - Henry Ford

The reasoning for such a system is as follows:
- Synchronise workflow between contributors
- Avoid duplicating effort
- Minimise conflicts
- Ensure all contributors are up to date
