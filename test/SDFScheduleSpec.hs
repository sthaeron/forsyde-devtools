...
spec = do
  describe "SDF scheduling examples" $ do
    it "exampleSystem1: System with single actor and self loop" $ do
      let Schedule (actualSchedule, actualBuffers, _) = computeScheduleAndBuffers exampleSystem1
    ...
    it "exampleSystem2: System with single actor and nothing else" $ do
      let Schedule (actualSchedule, actualBuffers, _) = computeScheduleAndBuffers exampleSystem2
    ...
    it "exampleSystem3: System with two actors, one self loop" $ do
      let Schedule (actualSchedule, actualBuffers, _) = computeScheduleAndBuffers exampleSystem3
    ...
    it "exampleSystem4: System with multiple inputs" $ do
      let Schedule (actualSchedule, actualBuffers, _) = computeScheduleAndBuffers exampleSystem4
    ...
    it "exampleSystem5" $ do
      let Schedule (actualSchedule, actualBuffers, _) = computeScheduleAndBuffers exampleSystem5
    ...
    it "exampleSystem6" $ do
      let Schedule (actualSchedule, actualBuffers, _) = computeScheduleAndBuffers exampleSystem6
